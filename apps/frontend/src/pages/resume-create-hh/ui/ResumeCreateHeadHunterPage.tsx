...
import ResumeHeadHunterUrlForm from "./ResumeHeadHunterUrlForm";

const ResumeCreateHeadHunterPage: React.FunctionComponent = () => {
  ...
  return defaultValues ? (
    ...
    <ResumeHeadHunterUrlForm onSubmit={setDefaultValues} />
  );
};

export default ResumeCreateHeadHunterPage;
