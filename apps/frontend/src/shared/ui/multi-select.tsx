...
export function MultiSelectContent({
  ...
  return (
    <>
      ...
      <PopoverContent
        align={align}
        className="min-w-[var(--radix-popover-trigger-width)] p-0 sm:w-full"
      >
        <Command {...props}>
          {canSearch ? (
            <CommandInput
