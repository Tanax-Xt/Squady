...
interface UserProfileCardUnverifiedAgentIconProps
  extends React.ComponentProps<"svg"> {}

const UserProfileCardUnverifiedAgentIcon: React.FunctionComponent<
  UserProfileCardUnverifiedAgentIconProps
...
export default UserProfileCardUnverifiedAgentIcon;
