...
interface UserProfileCardVerifiedAgentIconProps
  extends React.ComponentProps<"svg"> {}

const UserProfileCardVerifiedAgentIcon: React.FunctionComponent<
  UserProfileCardVerifiedAgentIconProps
...
export default UserProfileCardVerifiedAgentIcon;
